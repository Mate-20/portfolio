...
const HeaderTwo = () => {
  const lines = [
    "Hi",
    "My Name is Akash Jindal. I am a Software Developer with 2 Years of Experience.",
    ...
    <div className='flex flex-col w-full items-center justify-center'>
      ...
      <div className='w-full flex h-[380px] overflow-hidden items-start justify-center'>
        <motion.div
          ...
          className='flex flex-col w-[80%] shadow-[0_15px_20px_rgba(86,227,159,0.1)]'>
          <div className='flex items-center justify-between h-[45px] bg-[#27272a] w-full rounded-t-lg'>
            <div className='flex items-end gap-2 pl-3 h-full'>
              <div className='text-white flex items-center gap-2 bg-black rounded-t-md p-2 h-[35px] w-[200px]'>
                <SquareTerminal height={18} />
                <span className='text-white text-sm'>Windows PowerShell</span>
                <span>x</span>
              </div>
            ...
            <div className='flex h-full items-center text-white'>
              <div className='h-full flex items-center justify-center hover:bg-[#444444] w-[35px]'>
                <Minus height={15} /></div>
              <div className='h-full flex items-center justify-center hover:bg-[#444444] w-[35px]'>
                <Square height={15} /></div>
              <div className='h-full flex items-center justify-center rounded-se-lg hover:bg-red-500 w-[35px]'>
                <X height={15} /></div>
            </div>
          </div>
          {/* Terminal Body */}
